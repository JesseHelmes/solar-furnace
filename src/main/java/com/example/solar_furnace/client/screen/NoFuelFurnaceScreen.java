...
import com.example.solar_furnace.menu.NoFuelFurnaceMenu;
...
@OnlyIn(Dist.CLIENT)
public class NoFuelFurnaceScreen <T extends NoFuelFurnaceMenu> extends AbstractContainerScreen<T> implements RecipeUpdateListener {
	private static final ResourceLocation RECIPE_BUTTON_LOCATION = new ResourceLocation("textures/gui/recipe_button.png");
	public final AbstractFurnaceRecipeBookComponent recipeBookComponent;
	private boolean widthTooNarrow;
	private final ResourceLocation texture;

	public NoFuelFurnaceScreen(T menu, AbstractFurnaceRecipeBookComponent p_97826_, Inventory inventory, Component component, ResourceLocation texture) {
	...
	protected void renderBg(GuiGraphics p_282928_, float p_281631_, int p_281252_, int p_281891_) {
		...
		if (this.menu.isLit()) {
			...
			p_282928_.blit(this.texture, i + 56, j + 36 + 12 - k + ingredientOffsetFromOrignal, 176, 12 - k, 14, k + 1);
		}
